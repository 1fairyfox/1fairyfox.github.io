...
| [cross-project-sync](cross-project-sync.md) | the inbound/outbound flows match the runbooks | [cross-project-sync anti-recursion checklist](cross-project-sync.md#anti-recursion-checklist) — pulls on-request, read-only, git-ignored, copy-not-link |
